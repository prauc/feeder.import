 ...
 * Video
 *
 * @ORM\Table(name="video", uniqueConstraints={@ORM\UniqueConstraint(name="sourceVideoId", columns={"videoSourceId"})})
 * @ORM\Entity
 */
class Video
{
     ...
     * @var int|null
     *
     * @ORM\Column(name="videoCategoryId", type="integer", nullable=true, options={"unsigned"=true})
     */
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="invalidation", type="date", nullable=true)
     */
