 ...
 */
final class Version20190718065313 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE match_status CHANGE sportal sportal VARCHAR(50) DEFAULT NULL, CHANGE opta opta VARCHAR(50) DEFAULT NULL, CHANGE gsm gsm VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE match_status CHANGE sportal sportal VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE opta opta VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE gsm gsm VARCHAR(50) CHARACTER SET utf8mb4 NOT NULL COLLATE utf8mb4_unicode_ci');
        $this->addSql('ALTER TABLE statistic CHANGE _date _date DATE NOT NULL');
    }
}
